...
// Bislig Hub branding: use the approved Hub logo from public assets.
// (The Bislig Ride logo file is intentionally not referenced here.)
const bisligLogo = '/assets/bislig-hub-logo.png'
